...
//newsletters
Route::get('admin/sub/newsletters', 'Admin\Category\NewsLetterController@NewsLetters')->name('admin.newsletters');
...
// all product route
Route::get('admin/all/product', 'Admin\ProductController@index')->name('all.product');
...
Route::post('update/product/image/{id}', 'Admin\ProductController@UpdateProductWithImage');
...
Route::get('edit/blogpost/{id}', 'Admin\PostController@EditBlogPost');
Route::get('delete/blogpost/{id}', 'Admin\PostController@DeleteBlogPost');
Route::post('update/blog/withoutimage/{id}', 'Admin\PostController@UpdateBlogWithoutImage');
Route::post('update/blog/image/{id}', 'Admin\PostController@UpdateBlogWithImage');


//frontend newsletter route
...
Route::get('product/details/{id}/{product_name}', 'ProductController@ViewProduct');
...
Route::get('admin/accept/payment/', 'Admin\OrderController@AcceptedPayment')->name('admin.accept.payment');
...
Route::post('admin/site/update', 'Admin\SettingController@UpdateSiteSetting')->name('admin.site.update');
