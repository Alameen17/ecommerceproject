                            ...
                            <button type="submit" class="btn btn-danger ml-2">Submit      	
                             ...
                             <ul class="list-group col-lg-4" style="float: right;">
                                @if(Session::has('coupon'))
                                    ...
                                    <a href="{{ route('remove.coupon') }}" class="btn btn-danger btn-sm" title="Cancel">x</a>
                                ...
                                @endif
                                    ...
                                    <li class="list-group-item">Shipping Fee : <span style="float: right;">${{ $charge }} </span> </li>
