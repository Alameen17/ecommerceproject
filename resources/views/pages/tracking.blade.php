...
<div class="progress-bar bg-danger" role="progressbar" style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
 ...
 @elseif($track->status == 1)
  <h4>Note : Payment is Under review..  </h4>

   @elseif($track->status == 2)
  <h4>Note : Packing Done Handover in Process..  </h4>

  @elseif($track->status == 3)
  <h4>Note : Order has been Completed!  </h4>

 @else

 <h4>Note : Order has been Canceled!  </h4>
 ...
 @endif
  ...
  <ul class="list-group col-lg-12">
  	...
  	<li class="list-group-item"> <b>Balance ID:</b> {{ $track->blnc_transaction  }}</li>
  	<li class="list-group-item"> <b>Subtotal:</b> $ {{ $track->subtotal  }}</li>
  	<li class="list-group-item"> <b>Shipping Fee:</b> $ {{ $track->shipping  }}</li>
  	<li class="list-group-item"> <b>Vat:</b> $ {{ $track->vat  }}</li>
  	<li class="list-group-item"> <b>Total Amount:</b> $ {{ $track->total  }}</li>
  	<li class="list-group-item"> <b>Month:</b> {{ $track->month  }}</li>
  	<li class="list-group-item"> <b>Date:</b> {{ $track->day  }}</li>
