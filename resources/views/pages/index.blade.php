...
$trend = DB::table('products')->where('status',1)->where('trending',1)->orderBy('id','desc')->limit(6)->get();
                            ...
                            <div class="owl-item deals_item">
                                ...
                                <div class="deals_content">
                                    ...
                                    <div class="deals_info_line d-flex flex-row justify-content-start">
                                        ...
                                        @if ($ht->discount_price != NULL)
                                        <div class="deals_item_price_a ml-auto" style="color: red;"><h3>${{ $ht->discount_price }}</h3></div>
                                        @else
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="{{ asset( $row->image_one )}}" alt="" style="height: 120px; width: 110px;"></div>
                        ...
                        <div class="row fill_height">
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img src="{{ asset( $row->image_one )}}" alt="" style="width: 250px; height: 300px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>          
...
<!-- New Hot Category One -->

@php
    $cats = DB::table('categories')->skip(1)->first();
    $catid = $cats->id;

    $product = DB::table('products')->where('category_id',$catid)->where('status',1)->limit(8)->orderBy('id','desc')->get();
@endphp
                        ...
                        <div class="owl-item">
                            <div class="trends_item is_new">
                                ...
                                <ul class="trends_marks">
                                    ...
                                    <li class="trends_mark trends_new">Gift</li>
                                </ul>
                                <button class="addwishlist" data-id="{{ $row->id }}">
