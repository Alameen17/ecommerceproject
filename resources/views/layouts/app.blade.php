                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ url('/') }}">UPSTYLE</a></div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
     ...
     <form method="post" action="{{ route('order.tracking') }}">
      ...
      <div class="modal-body">
          ...
          <input type="text" name="code" required="" class="form-control" placeholder="Type your Order Status Code">        
      </div>
    ...
    $(document).on("click", "#return", function(e){
        ...
        var link = $(this).attr("href");
           swal({
             ...
             text: "Once Returned, your money will be refunded!",
             icon: "warning",
             buttons: true,
             dangerMode: true,
           })
