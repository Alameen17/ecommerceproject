            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    ...
                    @if($row->status == 1)
                    <a href="{{ URL::to('inactive/product/'.$row->id) }}" class="btn btn-sm btn-danger" title="Deactivate"><i class="fa fa-thumbs-down"></i></a>
                     @else
                     <a href="{{ URL::to('active/product/'.$row->id) }}" class="btn btn-sm btn-info" title="Activate"><i class="fa fa-thumbs-up"></i></a>
                    @endif
                </td>
              </tr>
              @endforeach
