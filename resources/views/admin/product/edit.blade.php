...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <form action="{{ url('update/product/withoutimage/'.$product->id) }}" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <div class="form-layout">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                    <label class="ckbox">
                        <input type="checkbox" name="trending" value="1" <?php if ($product->trending == 1) {
                            echo "checked"; } ?>>
...
<div class="sl-pagebody">
    <div class="card pd-20 pd-sm-40">
        ...
        <form action="{{ url('update/product/image/'.$product->id) }}" method="post" enctype="multipart/form-data">
            @csrf
        ...
        <div class="col-lg-6 col-sm-6">
          ...
          <div class="row">
            <div class="col-lg-6 col-sm-6">
                  ...
                  <label class="form-control-label">Image One (2): <span class="tx-danger">*</span></label><br>
                  <label class="custom-file">
