...
<html lang="en">
  ...
  <body>
    ...
    @else
       <!-- ########## START: LEFT PANEL ########## -->
       <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Upstyle Shop</a></div>
         ...
         <div class="sl-sideleft-menu">
           ...
           @if (Auth::user()->order == 1)
            ...
            <ul class="sl-menu-sub nav flex-column">
              ...
              <li class="nav-item"><a href="{{ route('admin.accept.payment') }}" class="nav-link">Accepted Payments</a></li>
          ...
          @if (Auth::user()->blog == 1)
            ...
            <ul class="sl-menu-sub nav flex-column">
              ...
              <li class="nav-item"><a href="{{ route('all.blogpost') }}" class="nav-link">Posts List</a></li>
            </ul>
          @else
          @endif
