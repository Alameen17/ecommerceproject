...
class PaymentController extends Controller
{
    ...
    public function StripeCharge(Request $request){
           ...
           \Stripe\Stripe::setApiKey('sk_test_51KgOlWG48ofHFdzRW59jaXa7WwmXxgwsa8tsrVpWxYD7XK4aXfUYcmF1Y0XdiYofqXSboZHncGaiS8z2R5MNQbqd00WMD4XS7x');
           ...
           $charge = \Stripe\Charge::create([
               'amount' => $total*100,
               'currency' => 'usd',
               'description' => 'Upstyle Shop Details',
               'source' => $token,
      ...
      // Send mail to user for Invoice
       ...
       $notification=array(
            'messege'=>'Order has been Successfully Made!',
            'alert-type'=>'success'
            );
